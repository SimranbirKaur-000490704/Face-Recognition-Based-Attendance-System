...
class FaceRecognitionCNN:
        ...
        for root, dirs, files in os.walk(self.images_folder):
            for file in files:
                if file.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp')):
                    ...
                    img = cv2.resize(img, (250, 250))  # Resize image to 224x224
                    images.append(img)
    ...
    def train(self, test_size=0.2, epochs=20, batch_size=10):
        ...
        checkpoint = ModelCheckpoint('trainer/best_model.h5', monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
